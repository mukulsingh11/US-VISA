...
class DataIngestion:
    ...
    def download_data(self) -> str:
        try:
            ...
            logging.info(f"File :[{raw_file_path}] has been downloading successfully")
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            # creating the data object of today data
            ...
            train_set ,test_set = train_test_split(us_visa_dataframe,test_size = 0.2 , random_state=35)
            ...
            data_ingestion_artifact = DataIngestionArtifact(train_file_path=train_file_path,
                                                            ...
                                                            is_ingested=True,
                                                            message = f"Data ingestion completedsuccessfully")
