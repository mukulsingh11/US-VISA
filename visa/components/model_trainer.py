...
# load transformed training and testing dataset
#creading model config file
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) ->ModelTrainerArtifact:
        try:
            ...
            logging.info(f"Initialing operation model selection")
    ...
    def __del__(self):
        logging.info(f'{">>"*20} Model trainer is completed {"<<"*20}')
