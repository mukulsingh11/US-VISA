...
ModelTrainerArtifact = namedtuple("ModelTrainerArtifact",['is_trained','message','trained_model_file_path','train_f1',
                                                          'test_f1','train_accuracy' , 'test_accuracy','model_accuracy'])
